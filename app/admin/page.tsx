...
export default async function AdminPanel() {
  ...
  return (
    <main className="px-24 pt-24 pb-32">
      <h1 className="pb-12 text-4xl font-black">Admin Panel</h1>
      <div className="flex gap-8">
        <section className="grow flex justify-center items-center gap-24 p-8 border border-zinc-500 rounded-sm">
          <div className="flex flex-col items-center">
            <h3 className="pb-4 text-9xl font-black">{overall.total_tasks}</h3>
          ...
          <div className="flex flex-col items-center">
            <h3 className="pb-4 text-9xl font-black">{convertMinutesToHM(overall.total_minutes)}</h3>
            <div className="flex items-center gap-2">
        ...
        <section className="grow flex flex-col justify-center items-center p-8 border border-zinc-500 rounded-sm">
          <h3 className="pb-4 text-9xl font-black">{usersData.length}</h3>
          <div className="flex items-center gap-2">
            <LeftToRightListNumberIcon width={50} height={50} color="#71717a" />
